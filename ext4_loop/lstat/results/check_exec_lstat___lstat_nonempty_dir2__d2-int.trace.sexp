(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'lstat___lstat_nonempty_dir2__d2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " Test lstat___lstat_nonempty_dir2__d2")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_LSTAT (CS_Some nonempty_dir2/d2))))))))))
  (trace_line
   ((73)
    (Label
     (false
