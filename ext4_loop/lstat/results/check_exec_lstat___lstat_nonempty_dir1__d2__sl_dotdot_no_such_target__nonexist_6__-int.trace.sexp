(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'lstat___lstat_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test lstat___lstat_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6__")))
  (d_lbls ()))
 ((trace_ctxt ())
