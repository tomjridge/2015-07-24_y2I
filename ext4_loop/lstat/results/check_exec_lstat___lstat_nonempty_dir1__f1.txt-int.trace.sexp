(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'lstat___lstat_nonempty_dir1__f1.txt-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " Test lstat___lstat_nonempty_dir1__f1.txt")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_LSTAT (CS_Some nonempty_dir1/f1.txt))))))))))
  (trace_line
   ((73)
    (Label
     (false
