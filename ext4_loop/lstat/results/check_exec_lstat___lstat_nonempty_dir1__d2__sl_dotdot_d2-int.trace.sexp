(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'lstat___lstat_nonempty_dir1__d2__sl_dotdot_d2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test lstat___lstat_nonempty_dir1__d2__sl_dotdot_d2")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_LSTAT (CS_Some nonempty_dir1/d2/sl_dotdot_d2))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL ((Pid 1) (OS_LSTAT (CS_Some nonempty_dir1/d2/sl_dotdot_d2)))))))))
  (d_lbls ()))
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 17)) (st_kind S_IFLNK)
             ...
             (st_gid (Group_id 0)) (st_rdev 0) (st_size 5)
