(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'mkdir___mkdir_nonempty_dir1__d2__sl_dotdot_f1.txt_____0777-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test mkdir___mkdir_nonempty_dir1__d2__sl_dotdot_f1.txt_____0777")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_MKDIR
           ((CS_Some nonempty_dir1/d2/sl_dotdot_f1.txt/) (File_perm 511)))))))))))
  (trace_line
   ((73)
    (Label
     (false
       ...
       ((DE_dir ((dir_path /) (dir_node 27)))
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 35)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 42)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 45)))
        (DE_symlink
