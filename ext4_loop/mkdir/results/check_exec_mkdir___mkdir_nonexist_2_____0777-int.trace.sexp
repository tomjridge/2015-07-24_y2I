(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'mkdir___mkdir_nonexist_2_____0777-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " Test mkdir___mkdir_nonexist_2_____0777")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_MKDIR ((CS_Some nonexist_2/) (File_perm 511)))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL ((Pid 1) (OS_MKDIR ((CS_Some nonexist_2/) (File_perm 511))))))))))
  (d_lbls ()))
