(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'mkdir___mkdir_nonexist_1___0777-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " Test mkdir___mkdir_nonexist_1___0777")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32644)))
        ...
        (DE_dir ((dir_path /nonexist_1) (dir_node 32648)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
