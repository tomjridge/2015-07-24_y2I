(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'mkdir___mkdir_nonempty_dir1__nonexist_4___0777-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test mkdir___mkdir_nonempty_dir1__nonexist_4___0777")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_MKDIR ((CS_Some nonempty_dir1/nonexist_4) (File_perm 511)))))))))))
  (trace_line
   ((73)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 20)))
        ...
        (DE_dir ((dir_path /nonempty_dir1/nonexist_4) (dir_node 32653)))
