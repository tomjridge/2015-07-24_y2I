(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'mkdir___mkdir_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6_____0777-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test mkdir___mkdir_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6_____0777")))
  (d_lbls ()))
 ((trace_ctxt ())
