(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'mkdir___mkdir_nonempty_dir1__d2__sl_no_such_target_____0777-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test mkdir___mkdir_nonempty_dir1__d2__sl_no_such_target_____0777")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_MKDIR
           ((CS_Some nonempty_dir1/d2/sl_no_such_target/) (File_perm 511)))))))))))
  (trace_line
   ((73)
    (Label
     (false
