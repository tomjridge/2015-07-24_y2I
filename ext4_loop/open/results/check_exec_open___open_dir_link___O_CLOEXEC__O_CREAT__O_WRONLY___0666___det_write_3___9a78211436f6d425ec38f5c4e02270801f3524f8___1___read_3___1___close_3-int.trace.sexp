(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'open___open_dir_link___O_CLOEXEC__O_CREAT__O_WRONLY___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test open___open_dir_link___O_CLOEXEC__O_CREAT__O_WRONLY___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((37)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_OPEN ((CS_Some dir_link) 524353 ((File_perm 438))))))))))))
  (trace_line
   ((37)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_file
         ((file_path /dir_link) (file_node 13) (file_size 1)
