(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'open___open_broken_sl___O_CLOEXEC__O_CREAT__O_EXEC__O_NOFOLLOW___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test open___open_broken_sl___O_CLOEXEC__O_CREAT__O_EXEC__O_NOFOLLOW___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32644)))
        (DE_file
         ((file_path /broken) (file_node 14) (file_size 0)
