(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'open___open_nonempty_dir__f2.txt___O_APPEND__O_CLOEXEC__O_DIRECTORY__O_NOFOLLOW__O_WRONLY___none___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test open___open_nonempty_dir__f2.txt___O_APPEND__O_CLOEXEC__O_DIRECTORY__O_NOFOLLOW__O_WRONLY___none___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((37)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_OPEN ((CS_Some nonempty_dir/f2.txt) 721921 ()))))))))))
  (trace_line
   ((37)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 15)))
        ...
        (DE_file
         ((file_path /nonempty_dir/f2.txt) (file_node 20) (file_size 31)
