(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'open___open_broken_sl___O_APPEND__O_CREAT__O_RDONLY___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test open___open_broken_sl___O_APPEND__O_CREAT__O_RDONLY___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        (DE_file
         ((file_path /broken) (file_node 27) (file_size 0)
