(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'open___open_nonempty_dir__f1.txt__nonexist3_____O_APPEND__O_CLOEXEC__O_CREAT__O_DIRECTORY__O_EXCL__O_RDWR___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test open___open_nonempty_dir__f1.txt__nonexist3_____O_APPEND__O_CLOEXEC__O_CREAT__O_DIRECTORY__O_EXCL__O_RDWR___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_OPEN
           ((CS_Some nonempty_dir/f1.txt/nonexist3/) 591042
            ((File_perm 438))))))))))))
  (trace_line
   ((37)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_OPEN
          ((CS_Some nonempty_dir/f1.txt/nonexist3/) 591042 ((File_perm 438)))))))))))
  (d_lbls ()))
