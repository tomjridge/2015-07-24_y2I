(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'open___open_broken_sl___O_APPEND__O_CREAT__O_NOFOLLOW__O_RDONLY__O_TRUNC___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test open___open_broken_sl___O_APPEND__O_CREAT__O_NOFOLLOW__O_RDONLY__O_TRUNC___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((37)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_OPEN ((CS_Some broken_sl) 132672 ((File_perm 438))))))))))))
  (trace_line
   ((37)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 15)))
        (DE_file
         ((file_path /broken) (file_node 38) (file_size 0)
        ...
        (DE_file
         ((file_path /nonempty_dir/f1.txt) (file_node 31) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir/f2.txt) (file_node 33) (file_size 30)
