(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'open___open_nonempty_dir__f2.txt___O_CLOEXEC__O_CREAT__O_DIRECTORY__O_NOFOLLOW__O_RDWR___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test open___open_nonempty_dir__f2.txt___O_CLOEXEC__O_CREAT__O_DIRECTORY__O_NOFOLLOW__O_RDWR___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_OPEN ((CS_Some nonempty_dir/f2.txt) 720962 ((File_perm 438))))))))))))
  (trace_line
   ((37)
    (Label
     (false
 ...
 ((trace_ctxt
   (((45)
     (Label
      (false (OS_simple_label (OS_RETURN ((Pid 1) (Value (RV_bytes o))))))))))
  (trace_line
   ((45)
    (Label
     (false (OS_simple_label (OS_RETURN ((Pid 1) (Value (RV_bytes o)))))))))
       ...
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_file
         ((file_path /nonempty_dir/f2.txt) (file_node 17) (file_size 30)
          (file_sha 2bd2f068203634dfb3d4e74fca06a7af401bb012)))))))))
  (trace_line
   ((50)
    (Dump_result
     (/
