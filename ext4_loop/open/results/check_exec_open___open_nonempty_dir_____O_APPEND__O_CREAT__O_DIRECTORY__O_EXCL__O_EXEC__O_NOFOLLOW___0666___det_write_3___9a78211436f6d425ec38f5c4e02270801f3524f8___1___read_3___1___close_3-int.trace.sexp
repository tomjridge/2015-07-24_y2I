(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'open___open_nonempty_dir_____O_APPEND__O_CREAT__O_DIRECTORY__O_EXCL__O_EXEC__O_NOFOLLOW___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test open___open_nonempty_dir_____O_APPEND__O_CREAT__O_DIRECTORY__O_EXCL__O_EXEC__O_NOFOLLOW___0666___det_write_3___9a78211436f6d425ec38f5c4e02270801f3524f8___1___read_3___1___close_3")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 21)))
        ...
        (DE_dir ((dir_path /empty_dir) (dir_node 29)))
        (DE_dir ((dir_path /nonempty_dir) (dir_node 30)))
        (DE_file
