(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonexist_dir__nonexist_3_____nonempty_dir2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test link___link_nonexist_dir__nonexist_3_____nonempty_dir2")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_LINK
           ((CS_Some nonexist_dir/nonexist_3/) (CS_Some nonempty_dir2)))))))))))
  (trace_line
   ((73)
    (Label
     (false
