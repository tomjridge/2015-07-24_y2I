(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__sl_f1.txt_____nonexist_dir__nonexist_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir1__sl_f1.txt_____nonexist_dir__nonexist_3")))
  (d_lbls ()))
 ((trace_ctxt ())
