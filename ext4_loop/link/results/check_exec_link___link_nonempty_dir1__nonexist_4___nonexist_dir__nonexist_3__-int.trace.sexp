(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__nonexist_4___nonexist_dir__nonexist_3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir1__nonexist_4___nonexist_dir__nonexist_3__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 15)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 30)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 32)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 34)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 36)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 47)))
        (DE_file
