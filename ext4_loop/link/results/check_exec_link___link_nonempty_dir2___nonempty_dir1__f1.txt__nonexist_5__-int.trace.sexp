(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir2___nonempty_dir1__f1.txt__nonexist_5__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir2___nonempty_dir1__f1.txt__nonexist_5__")))
  (d_lbls ()))
 ((trace_ctxt ())
