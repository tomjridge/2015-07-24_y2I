(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonexist_dir__nonexist_3_____nonempty_dir1__nonexist_4-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonexist_dir__nonexist_3_____nonempty_dir1__nonexist_4")))
  (d_lbls ()))
 ((trace_ctxt ())
