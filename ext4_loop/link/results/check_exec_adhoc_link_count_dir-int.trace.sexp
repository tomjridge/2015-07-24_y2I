(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'adhoc_link_count_dir-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((5) (Comment " Test link count of directories after link")))
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line
   ((6) (Comment ################################################)))
 ...
 ((trace_ctxt ())
  (trace_line
   ((8) (Comment " a new created directory should have link count 2")))
  (d_lbls ()))
 ...
 ((trace_ctxt
   (((10)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_MKDIR ((CS_Some dir) (File_perm 448)))))))))))
  (trace_line
   ((10)
    (Label
     (false
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 32641)) (st_kind S_IFDIR)
             (st_perm (File_perm 448)) (st_nlink 2) (st_uid (User_id 0))
 ...
 ((trace_ctxt
   (((19)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_LINK ((CS_Some dir) (CS_Some dir_hl)))))))))))
  (trace_line
   ((19)
    (Label
     (false
 ...
 ((trace_ctxt
   (((25)
     (Label
      (false
       (OS_simple_label (OS_CALL ((Pid 1) (OS_STAT (CS_Some dir_hl))))))))))
  (trace_line
   ((25)
    (Label
     (false (OS_simple_label (OS_CALL ((Pid 1) (OS_STAT (CS_Some dir_hl)))))))))
  (d_lbls ()))
 ...
 ((trace_ctxt
   (((31)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_LINK ((CS_Some dir_hl) (CS_Some dir_hl1)))))))))))
  (trace_line
   ((31)
    (Label
     (false
 ...
 ((trace_ctxt
   (((40)
     (Label
      (false
       (OS_simple_label (OS_CALL ((Pid 1) (OS_STAT (CS_Some dir_hl1))))))))))
  (trace_line
   ((40)
    (Label
     (false
 ...
 ((trace_ctxt
   (((44)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_LINK ((CS_Some dir_hl1) (CS_Some dir_hl2)))))))))))
  (trace_line
   ((44)
    (Label
     (false
 ...
 ((trace_ctxt
   (((56)
     (Label
      (false
       (OS_simple_label (OS_CALL ((Pid 1) (OS_STAT (CS_Some dir_hl2))))))))))
  (trace_line
   ((56)
    (Label
     (false
