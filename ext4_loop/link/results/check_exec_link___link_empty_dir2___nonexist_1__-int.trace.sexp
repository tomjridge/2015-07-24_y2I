(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_empty_dir2___nonexist_1__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " Test link___link_empty_dir2___nonexist_1__")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_LINK ((CS_Some empty_dir2) (CS_Some nonexist_1/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
