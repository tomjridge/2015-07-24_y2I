(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__d2__sl_dotdot_d2___nonempty_dir1__f1.txt__nonexist_5-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir1__d2__sl_dotdot_d2___nonempty_dir1__f1.txt__nonexist_5")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 21)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 55)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 56)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 57)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 58)))
        (DE_file
         ((file_path /nonempty_dir1/d2/f3.txt) (file_node 59) (file_size 83)
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 60)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 22)))
        (DE_file
