(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir2_____nonempty_dir2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test link___link_nonempty_dir2_____nonempty_dir2")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 38)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 41)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 43)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 44)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 45)))
        (DE_file
