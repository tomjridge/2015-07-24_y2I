(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__f1.txt__nonexist_5___nonempty_dir1__f1.txt-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir1__f1.txt__nonexist_5___nonempty_dir1__f1.txt")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 25)))
        ...
        (DE_dir ((dir_path /empty_dir2) (dir_node 38)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 39)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 41)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 17)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
