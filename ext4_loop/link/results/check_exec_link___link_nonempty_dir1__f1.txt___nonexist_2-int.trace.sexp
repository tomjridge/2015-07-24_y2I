(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__f1.txt___nonexist_2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test link___link_nonempty_dir1__f1.txt___nonexist_2")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_LINK ((CS_Some nonempty_dir1/f1.txt) (CS_Some nonexist_2)))))))))))
  (trace_line
   ((73)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 65282)))
        (DE_file
         ((file_path /nonexist_2) (file_node 18) (file_size 0)
