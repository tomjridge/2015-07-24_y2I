(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__d2__f3.txt_____empty_dir1__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test link___link_nonempty_dir1__d2__f3.txt_____empty_dir1__")))
  (d_lbls ()))
 ((trace_ctxt ())
    ...
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_LINK ((CS_Some nonempty_dir1/d2/f3.txt/) (CS_Some empty_dir1/))))))))))
  (d_lbls ()))
