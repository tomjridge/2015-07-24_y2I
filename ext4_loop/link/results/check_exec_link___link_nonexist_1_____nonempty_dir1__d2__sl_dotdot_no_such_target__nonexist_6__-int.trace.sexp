(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonexist_1_____nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonexist_1_____nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 14)))
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 13)))
        (DE_file
