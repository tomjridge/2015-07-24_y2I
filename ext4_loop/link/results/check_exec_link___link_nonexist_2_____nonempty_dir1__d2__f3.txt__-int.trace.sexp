(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonexist_2_____nonempty_dir1__d2__f3.txt__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test link___link_nonexist_2_____nonempty_dir1__d2__f3.txt__")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_LINK
           ((CS_Some nonexist_2/) (CS_Some nonempty_dir1/d2/f3.txt/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_LINK ((CS_Some nonexist_2/) (CS_Some nonempty_dir1/d2/f3.txt/))))))))))
  (d_lbls ()))
