(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__d2__d3_____nonempty_dir2__d2__d3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir1__d2__d3_____nonempty_dir2__d2__d3__")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_LINK
           ((CS_Some nonempty_dir1/d2/d3/) (CS_Some nonempty_dir2/d2/d3/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
