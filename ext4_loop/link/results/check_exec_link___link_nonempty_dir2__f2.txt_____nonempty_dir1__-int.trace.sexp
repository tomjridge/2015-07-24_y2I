(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir2__f2.txt_____nonempty_dir1__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test link___link_nonempty_dir2__f2.txt_____nonempty_dir1__")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_LINK
           ((CS_Some nonempty_dir2/f2.txt/) (CS_Some nonempty_dir1/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_LINK ((CS_Some nonempty_dir2/f2.txt/) (CS_Some nonempty_dir1/))))))))))
  (d_lbls ()))
