(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6_____nonempty_dir1__nonexist_4__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6_____nonempty_dir1__nonexist_4__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 65284)))
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 65286)))
        (DE_file
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 97922)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 65281)))
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 12) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 13) (file_size 167)
