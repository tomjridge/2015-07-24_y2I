(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir2__d2__d3___nonempty_dir1__d2__sl_dotdot_d2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir2__d2__d3___nonempty_dir1__d2__sl_dotdot_d2__")))
  (d_lbls ()))
 ((trace_ctxt ())
       ...
       ((DE_dir ((dir_path /) (dir_node 15)))
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 29)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 43)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 51)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
