(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir2__f2.txt___nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir2__f2.txt___nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32650)))
        ...
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 32642)))
        (DE_file
