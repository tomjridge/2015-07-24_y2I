(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__f1.txt___nonexist_dir__nonexist_3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir1__f1.txt___nonexist_dir__nonexist_3__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_LINK
          ((CS_Some nonempty_dir1/f1.txt) (CS_Some nonexist_dir/nonexist_3/))))))))))
  (d_lbls ()))
