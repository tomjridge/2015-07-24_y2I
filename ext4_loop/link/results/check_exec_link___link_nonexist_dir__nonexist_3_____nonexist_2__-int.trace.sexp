(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonexist_dir__nonexist_3_____nonexist_2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test link___link_nonexist_dir__nonexist_3_____nonexist_2__")))
  (d_lbls ()))
 ((trace_ctxt ())
    ...
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_LINK ((CS_Some nonexist_dir/nonexist_3/) (CS_Some nonexist_2/))))))))))
  (d_lbls ()))
