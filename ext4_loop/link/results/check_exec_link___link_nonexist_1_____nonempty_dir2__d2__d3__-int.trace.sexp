(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonexist_1_____nonempty_dir2__d2__d3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test link___link_nonexist_1_____nonempty_dir2__d2__d3__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_LINK ((CS_Some nonexist_1/) (CS_Some nonempty_dir2/d2/d3/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
