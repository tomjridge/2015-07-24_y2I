(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6___nonempty_dir2__d2__d3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6___nonempty_dir2__d2__d3__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 31)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 65285)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 65286)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 65287)))
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 47) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonempty_dir1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 65288)))
        (DE_file
         ((file_path /nonempty_dir1/d2/f3.txt) (file_node 42) (file_size 83)
        ...
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 49) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 50) (file_size 167)
          (file_sha d09f4e47c22373e56c2369633ac3dcb71d598601)))
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 65291)))
        (DE_symlink
