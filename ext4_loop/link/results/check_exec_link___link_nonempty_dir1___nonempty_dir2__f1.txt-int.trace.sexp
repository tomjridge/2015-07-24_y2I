(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1___nonempty_dir2__f1.txt-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test link___link_nonempty_dir1___nonempty_dir2__f1.txt")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_LINK ((CS_Some nonempty_dir1) (CS_Some nonempty_dir2/f1.txt)))))))))))
  (trace_line
   ((73)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 97922)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 97932)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 97933)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 97934)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 97935)))
        (DE_file
