(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir2__d2__sl_f3.txt_____nonempty_dir1__d2__d3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir2__d2__sl_f3.txt_____nonempty_dir1__d2__d3__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 16)))
        ...
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 21)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 22)))
        (DE_file
