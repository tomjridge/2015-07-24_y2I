(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir1__f1.txt_____nonempty_dir2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test link___link_nonempty_dir1__f1.txt_____nonempty_dir2__")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_LINK
           ((CS_Some nonempty_dir1/f1.txt/) (CS_Some nonempty_dir2/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_LINK ((CS_Some nonempty_dir1/f1.txt/) (CS_Some nonempty_dir2/))))))))))
  (d_lbls ()))
