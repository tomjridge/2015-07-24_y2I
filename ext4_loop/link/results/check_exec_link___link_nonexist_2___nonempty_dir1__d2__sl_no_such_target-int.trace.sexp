(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonexist_2___nonempty_dir1__d2__sl_no_such_target-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonexist_2___nonempty_dir1__d2__sl_no_such_target")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_LINK
          ((CS_Some nonexist_2) (CS_Some nonempty_dir1/d2/sl_no_such_target))))))))))
  (d_lbls ()))
