(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir2___nonexist_2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " Test link___link_nonempty_dir2___nonexist_2")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_LINK ((CS_Some nonempty_dir2) (CS_Some nonexist_2)))))))))))
  (trace_line
   ((73)
    (Label
     (false
