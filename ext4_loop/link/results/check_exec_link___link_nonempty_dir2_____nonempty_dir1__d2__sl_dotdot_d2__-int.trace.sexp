(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'link___link_nonempty_dir2_____nonempty_dir1__d2__sl_dotdot_d2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test link___link_nonempty_dir2_____nonempty_dir1__d2__sl_dotdot_d2__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 15)))
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 53)))
        (DE_symlink
         ((link_path /nonempty_dir2/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 54)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
