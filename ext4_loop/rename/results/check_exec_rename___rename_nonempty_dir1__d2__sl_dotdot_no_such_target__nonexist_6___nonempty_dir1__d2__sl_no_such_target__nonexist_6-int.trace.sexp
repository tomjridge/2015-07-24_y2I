(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6___nonempty_dir1__d2__sl_no_such_target__nonexist_6-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6___nonempty_dir1__d2__sl_no_such_target__nonexist_6")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 31) (file_size 0)
        ...
        (DE_file
         ((file_path /nonempty_dir1/d2/f3.txt) (file_node 26) (file_size 83)
        ...
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 33) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
