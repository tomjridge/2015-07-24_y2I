(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1_____nonempty_dir2__d2__d3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test rename___rename_nonempty_dir1_____nonempty_dir2__d2__d3")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 32642)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 32643)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 65283)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 65284)))
        (DE_symlink
         ((link_path /nonempty_dir2/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 32644)))
        (DE_file
         ((file_path /nonempty_dir2/d2/d3/f1.txt) (file_node 18)
          (file_size 0) (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink
         ((link_path /nonempty_dir2/d2/d3/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3/d2) (dir_node 65281)))
        (DE_file
         ((file_path /nonempty_dir2/d2/d3/d2/f3.txt) (file_node 13)
        ...
        (DE_symlink
         ((link_path /nonempty_dir2/d2/d3/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3/d2/d3) (dir_node 65282)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
      ((DE_dir ((dir_path /) (dir_node 32641)))
       ...
       (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 32644)))
       (DE_file
        ((file_path /nonempty_dir2/d2/d3/f1.txt) (file_node 18) (file_size 0)
         (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
       (DE_symlink
        ((link_path /nonempty_dir2/d2/d3/sl_f1.txt) (link_val f1.txt)))
       (DE_dir ((dir_path /nonempty_dir2/d2/d3/d2) (dir_node 65281)))
