(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2_____nonempty_dir1__d2__sl_dotdot_no_such_target-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2_____nonempty_dir1__d2__sl_dotdot_no_such_target")))
  (d_lbls ()))
 ((trace_ctxt ())
