(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2_____nonempty_dir1__nonexist_4__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2_____nonempty_dir1__nonexist_4__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32642)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 32647)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 32650)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 32651)))
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 30) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonempty_dir1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonempty_dir1/nonexist_4) (dir_node 32652)))
        (DE_file
         ((file_path /nonempty_dir1/nonexist_4/f3.txt) (file_node 12)
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/nonexist_4/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/nonexist_4/d3) (dir_node 32653)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 32641)))
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 26) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 27) (file_size 167)
          (file_sha d09f4e47c22373e56c2369633ac3dcb71d598601)))
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 32645)))
        (DE_symlink
