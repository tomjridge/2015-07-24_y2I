(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2__f2.txt_____nonexist_2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test rename___rename_nonempty_dir2__f2.txt_____nonexist_2")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_RENAME ((CS_Some nonempty_dir2/f2.txt/) (CS_Some nonexist_2)))))))))))
  (trace_line
   ((73)
    (Label
     (false
