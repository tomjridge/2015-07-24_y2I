(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1___empty_dir1-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1___empty_dir1")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 97922)))
        ...
        (DE_file
         ((file_path /empty_dir1/f1.txt) (file_node 21) (file_size 0)
        ...
        (DE_symlink
         ((link_path /empty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /empty_dir1/d2/d3) (dir_node 97926)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 97923)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 97927)))
        (DE_file
