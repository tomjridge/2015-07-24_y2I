(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2___nonexist_2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1__d2___nonexist_2__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 97923)))
        ...
        (DE_dir ((dir_path /nonexist_2) (dir_node 32642)))
        (DE_file
         ((file_path /nonexist_2/f3.txt) (file_node 13) (file_size 83)
        ...
        (DE_symlink
         ((link_path /nonexist_2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonexist_2/d3) (dir_node 32641)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
