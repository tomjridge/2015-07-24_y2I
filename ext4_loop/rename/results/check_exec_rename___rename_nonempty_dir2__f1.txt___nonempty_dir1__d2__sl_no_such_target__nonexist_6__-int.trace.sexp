(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2__f1.txt___nonempty_dir1__d2__sl_no_such_target__nonexist_6__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2__f1.txt___nonempty_dir1__d2__sl_no_such_target__nonexist_6__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 18)))
        ...
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 14)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 15)))
        (DE_file
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 19)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 26)))
        (DE_file
