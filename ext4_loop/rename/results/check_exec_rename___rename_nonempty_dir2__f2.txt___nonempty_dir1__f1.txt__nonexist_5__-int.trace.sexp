(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2__f2.txt___nonempty_dir1__f1.txt__nonexist_5__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2__f2.txt___nonempty_dir1__f1.txt__nonexist_5__")))
  (d_lbls ()))
 ((trace_ctxt ())
