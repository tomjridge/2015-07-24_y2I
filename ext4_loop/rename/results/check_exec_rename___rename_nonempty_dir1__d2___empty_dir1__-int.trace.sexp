(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2___empty_dir1__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1__d2___empty_dir1__")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((77)
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 33)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 16)))
        (DE_file
         ((file_path /empty_dir1/f3.txt) (file_node 17) (file_size 83)
        ...
        (DE_symlink
         ((link_path /empty_dir1/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /empty_dir1/d3) (dir_node 18)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 14)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 15)))
        (DE_file
