(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__sl_dotdot_f1.txt_____nonempty_dir1__d2__d3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__sl_dotdot_f1.txt_____nonempty_dir1__d2__d3__")))
  (d_lbls ()))
 ((trace_ctxt ())
       ...
       ((DE_dir ((dir_path /) (dir_node 16)))
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 65290)))
