(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__sl_dotdot_no_such_target_____nonempty_dir2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__sl_dotdot_no_such_target_____nonempty_dir2__")))
  (d_lbls ()))
 ((trace_ctxt ())
