(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2__f2.txt_____nonempty_dir2__d2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2__f2.txt_____nonempty_dir2__d2__")))
  (d_lbls ()))
 ((trace_ctxt ())
