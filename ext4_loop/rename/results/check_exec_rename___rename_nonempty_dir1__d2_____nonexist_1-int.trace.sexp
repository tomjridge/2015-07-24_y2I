(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2_____nonexist_1-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1__d2_____nonexist_1")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 13)))
        ...
        (DE_dir ((dir_path /nonexist_1) (dir_node 32645)))
        (DE_file
         ((file_path /nonexist_1/f3.txt) (file_node 15) (file_size 83)
        ...
        (DE_symlink
         ((link_path /nonexist_1/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonexist_1/d3) (dir_node 32646)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
