(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__d3_____empty_dir2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test rename___rename_nonempty_dir1__d2__d3_____empty_dir2")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_RENAME ((CS_Some nonempty_dir1/d2/d3/) (CS_Some empty_dir2)))))))))))
  (trace_line
   ((73)
    (Label
     (false
