(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6_____nonexist_dir__nonexist_3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6_____nonexist_dir__nonexist_3__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 23)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 25)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 26)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 27)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 28)))
        (DE_file
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 30)))
