(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__sl_no_such_target___nonexist_2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__sl_no_such_target___nonexist_2__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 13)))
        ...
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 35)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 45)))
        (DE_file
