(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__sl_no_such_target__nonexist_6_____nonempty_dir2__f1.txt-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__sl_no_such_target__nonexist_6_____nonempty_dir2__f1.txt")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 17)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 32)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 40)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 41)))
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 49) (file_size 0)
        ...
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 51)))
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 52) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 53) (file_size 167)
          (file_sha d09f4e47c22373e56c2369633ac3dcb71d598601)))
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 54)))
        (DE_symlink
         ((link_path /nonempty_dir2/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 55)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
