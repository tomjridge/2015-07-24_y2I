(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonexist_dir__nonexist_3___nonempty_dir1__d2__sl_no_such_target__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonexist_dir__nonexist_3___nonempty_dir1__d2__sl_no_such_target__")))
  (d_lbls ()))
 ((trace_ctxt ())
