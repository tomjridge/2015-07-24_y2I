(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2___empty_dir2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1__d2___empty_dir2")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 13)))
        ...
        (DE_file
         ((file_path /empty_dir2/f3.txt) (file_node 15) (file_size 83)
        ...
        (DE_symlink
         ((link_path /empty_dir2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /empty_dir2/d3) (dir_node 16)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 20)))
        (DE_file
        ...
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 25) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 26) (file_size 167)
