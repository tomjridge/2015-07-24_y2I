(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1_____empty_dir2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1_____empty_dir2__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_file
         ((file_path /empty_dir2/f1.txt) (file_node 29) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /empty_dir2/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /empty_dir2/d2) (dir_node 32652)))
        (DE_file
         ((file_path /empty_dir2/d2/f3.txt) (file_node 22) (file_size 83)
        ...
        (DE_symlink
         ((link_path /empty_dir2/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /empty_dir2/d2/d3) (dir_node 65283)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 32642)))
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 31) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 32) (file_size 167)
