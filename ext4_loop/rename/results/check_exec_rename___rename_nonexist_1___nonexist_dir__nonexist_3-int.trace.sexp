(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonexist_1___nonexist_dir__nonexist_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test rename___rename_nonexist_1___nonexist_dir__nonexist_3")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_RENAME
           ((CS_Some nonexist_1) (CS_Some nonexist_dir/nonexist_3)))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_RENAME ((CS_Some nonexist_1) (CS_Some nonexist_dir/nonexist_3))))))))))
  (d_lbls ()))
