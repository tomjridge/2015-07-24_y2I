(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1___nonexist_2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1___nonexist_2__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_RENAME ((CS_Some nonempty_dir1) (CS_Some nonexist_2/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1) (OS_RENAME ((CS_Some nonempty_dir1) (CS_Some nonexist_2/))))))))))
  (d_lbls ()))
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 65284)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 97921)))
        (DE_symlink
         ((link_path /nonempty_dir2/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 97922)))
        (DE_dir ((dir_path /nonexist_2) (dir_node 32644)))
        (DE_file
         ((file_path /nonexist_2/f1.txt) (file_node 19) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonexist_2/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonexist_2/d2) (dir_node 65281)))
        (DE_file
         ((file_path /nonexist_2/d2/f3.txt) (file_node 14) (file_size 83)
          (file_sha 4b535f836f6006423fc132a59e78dfcc4fe6292f)))
        (DE_symlink
         ((link_path /nonexist_2/d2/sl_dotdot_d2) (link_val ../d2)))
        (DE_symlink
         ((link_path /nonexist_2/d2/sl_dotdot_f1.txt) (link_val ../f1.txt)))
        (DE_symlink
         ((link_path /nonexist_2/d2/sl_dotdot_no_such_target)
          (link_val ../no_such_target)))
        (DE_symlink
         ((link_path /nonexist_2/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonexist_2/d2/d3) (dir_node 65282)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
