(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__sl_f1.txt___nonempty_dir1__nonexist_4-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__sl_f1.txt___nonempty_dir1__nonexist_4")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 13)))
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/nonexist_4) (link_val f1.txt)))
     ...
     (/
      ((DE_dir ((dir_path /) (dir_node 13)))
       ...
       (DE_file
        ((file_path /nonempty_dir1/f1.txt) (file_node 31) (file_size 0)
         (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
       (DE_symlink ((link_path /nonempty_dir1/nonexist_4) (link_val f1.txt)))
       (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 65282)))
       (DE_file
        ((file_path /nonempty_dir1/d2/f3.txt) (file_node 26) (file_size 83)
         (file_sha 4b535f836f6006423fc132a59e78dfcc4fe6292f)))
