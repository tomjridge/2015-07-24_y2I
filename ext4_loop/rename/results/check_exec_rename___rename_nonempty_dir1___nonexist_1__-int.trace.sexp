(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1___nonexist_1__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1___nonexist_1__")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((77)
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 20)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 36)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 37)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 32641)))
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 14) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 34) (file_size 167)
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 65283)))
        (DE_dir ((dir_path /nonexist_1) (dir_node 38)))
        (DE_file
         ((file_path /nonexist_1/f1.txt) (file_node 46) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonexist_1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonexist_1/d2) (dir_node 39)))
        (DE_file
         ((file_path /nonexist_1/d2/f3.txt) (file_node 40) (file_size 83)
        ...
        (DE_symlink
         ((link_path /nonexist_1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonexist_1/d2/d3) (dir_node 41)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
