(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2__f1.txt___nonempty_dir2__d2__sl_f3.txt-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2__f1.txt___nonempty_dir2__d2__sl_f3.txt")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32649)))
        ...
        (DE_file
         ((file_path /nonempty_dir2/d2/sl_f3.txt) (file_node 20)
    ...
    (Dump_result
     (/
      ((DE_dir ((dir_path /) (dir_node 32649)))
       ...
       (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 32647)))
       (DE_file
        ((file_path /nonempty_dir2/d2/sl_f3.txt) (file_node 20) (file_size 0)
         (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
       (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 32648))))))))
  (d_lbls ()))
