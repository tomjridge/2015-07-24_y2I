(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2__d2_____nonexist_dir__nonexist_3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2__d2_____nonexist_dir__nonexist_3")))
  (d_lbls ()))
 ((trace_ctxt ())
