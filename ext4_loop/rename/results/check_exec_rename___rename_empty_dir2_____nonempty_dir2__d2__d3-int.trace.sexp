(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_empty_dir2_____nonempty_dir2__d2__d3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test rename___rename_empty_dir2_____nonempty_dir2__d2__d3")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 18)))
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 13)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
