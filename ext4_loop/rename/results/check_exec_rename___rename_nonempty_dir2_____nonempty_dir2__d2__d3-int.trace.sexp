(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2_____nonempty_dir2__d2__d3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test rename___rename_nonempty_dir2_____nonempty_dir2__d2__d3")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_RENAME
           ((CS_Some nonempty_dir2/) (CS_Some nonempty_dir2/d2/d3)))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_RENAME ((CS_Some nonempty_dir2/) (CS_Some nonempty_dir2/d2/d3))))))))))
  (d_lbls ()))
