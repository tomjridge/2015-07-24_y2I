(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonexist_dir__nonexist_3_____nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonexist_dir__nonexist_3_____nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6")))
  (d_lbls ()))
 ((trace_ctxt ())
