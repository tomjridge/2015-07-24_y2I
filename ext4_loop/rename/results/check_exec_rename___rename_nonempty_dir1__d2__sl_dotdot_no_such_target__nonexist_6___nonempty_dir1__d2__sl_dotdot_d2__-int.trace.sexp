(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6___nonempty_dir1__d2__sl_dotdot_d2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6___nonempty_dir1__d2__sl_dotdot_d2__")))
  (d_lbls ()))
 ((trace_ctxt ())
         ...
         ((Pid 1)
          (OS_RENAME
           ((CS_Some nonempty_dir1/d2/sl_dotdot_no_such_target/nonexist_6)
            (CS_Some nonempty_dir1/d2/sl_dotdot_d2/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
