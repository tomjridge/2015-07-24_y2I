(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2_____empty_dir1-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1__d2_____empty_dir1")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_RENAME ((CS_Some nonempty_dir1/d2/) (CS_Some empty_dir1)))))))))))
  (trace_line
   ((73)
    (Label
     (false
 ...
 ((trace_ctxt
   (((77)
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32652)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 32645)))
        (DE_file
         ((file_path /empty_dir1/f3.txt) (file_node 20) (file_size 83)
          (file_sha 4b535f836f6006423fc132a59e78dfcc4fe6292f)))
        (DE_symlink ((link_path /empty_dir1/sl_dotdot_d2) (link_val ../d2)))
        (DE_symlink
         ((link_path /empty_dir1/sl_dotdot_f1.txt) (link_val ../f1.txt)))
        (DE_symlink
         ((link_path /empty_dir1/sl_dotdot_no_such_target)
          (link_val ../no_such_target)))
        (DE_symlink
         ((link_path /empty_dir1/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /empty_dir1/d3) (dir_node 32646)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 97924)))
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 32653)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
      ((DE_dir ((dir_path /) (dir_node 32652)))
       ...
       (DE_symlink
        ((link_path /empty_dir1/sl_dotdot_no_such_target)
         (link_val ../no_such_target)))
       (DE_symlink
        ((link_path /empty_dir1/sl_no_such_target) (link_val no_such_target)))
       (DE_dir ((dir_path /empty_dir1/d3) (dir_node 32646)))
       (DE_dir ((dir_path /empty_dir2) (dir_node 97924)))
       (DE_dir ((dir_path /nonempty_dir1) (dir_node 32643)))
       (DE_file
