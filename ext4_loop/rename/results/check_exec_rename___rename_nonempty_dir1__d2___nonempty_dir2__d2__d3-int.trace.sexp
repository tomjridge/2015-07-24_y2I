(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2___nonempty_dir2__d2__d3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2___nonempty_dir2__d2__d3")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32650)))
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 32645)))
        (DE_file
         ((file_path /nonempty_dir2/d2/d3/f3.txt) (file_node 13)
        ...
        (DE_symlink
         ((link_path /nonempty_dir2/d2/d3/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3/d3) (dir_node 32646)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
