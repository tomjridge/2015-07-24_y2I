(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonexist_2___nonempty_dir1__sl_f1.txt-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test rename___rename_nonexist_2___nonempty_dir1__sl_f1.txt")))
  (d_lbls ()))
 ((trace_ctxt ())
    ...
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_RENAME ((CS_Some nonexist_2) (CS_Some nonempty_dir1/sl_f1.txt))))))))))
  (d_lbls ()))
