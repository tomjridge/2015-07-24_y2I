(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2_____nonexist_2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir2_____nonexist_2__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_dir ((dir_path /nonexist_2) (dir_node 32648)))
        (DE_file
         ((file_path /nonexist_2/f1.txt) (file_node 21) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonexist_2/f2.txt) (file_node 22) (file_size 167)
          (file_sha d09f4e47c22373e56c2369633ac3dcb71d598601)))
        (DE_dir ((dir_path /nonexist_2/d2) (dir_node 32649)))
        (DE_symlink
         ((link_path /nonexist_2/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonexist_2/d2/d3) (dir_node 32650)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
