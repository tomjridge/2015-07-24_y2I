(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2__f2.txt___nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2__f2.txt___nonempty_dir1__d2__sl_dotdot_no_such_target__nonexist_6")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 65283)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 97924)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 65285)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 65286)))
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 36) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonempty_dir1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 65287)))
        (DE_file
        ...
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 39) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
