(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1_____nonexist_2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1_____nonexist_2")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 14)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 17)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 18)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 32648)))
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 34) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 36) (file_size 167)
          (file_sha d09f4e47c22373e56c2369633ac3dcb71d598601)))
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 32650)))
        (DE_symlink
         ((link_path /nonempty_dir2/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 32651)))
        (DE_dir ((dir_path /nonexist_2) (dir_node 19)))
        (DE_file
         ((file_path /nonexist_2/f1.txt) (file_node 29) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonexist_2/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonexist_2/d2) (dir_node 20)))
        (DE_file
         ((file_path /nonexist_2/d2/f3.txt) (file_node 21) (file_size 83)
        ...
        (DE_symlink
         ((link_path /nonexist_2/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonexist_2/d2/d3) (dir_node 32645)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
