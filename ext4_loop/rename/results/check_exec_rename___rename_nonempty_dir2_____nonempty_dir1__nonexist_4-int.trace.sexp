(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2_____nonempty_dir1__nonexist_4-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2_____nonempty_dir1__nonexist_4")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((77)
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 15)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 18)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 32641)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 32643)))
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 33) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonempty_dir1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 32645)))
        (DE_file
         ((file_path /nonempty_dir1/d2/f3.txt) (file_node 22) (file_size 83)
        ...
        (DE_dir ((dir_path /nonempty_dir1/nonexist_4) (dir_node 32649)))
        (DE_file
         ((file_path /nonempty_dir1/nonexist_4/f1.txt) (file_node 37)
          (file_size 0) (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir1/nonexist_4/f2.txt) (file_node 38)
          (file_size 167)
          (file_sha d09f4e47c22373e56c2369633ac3dcb71d598601)))
        (DE_dir ((dir_path /nonempty_dir1/nonexist_4/d2) (dir_node 32652)))
        (DE_symlink
         ((link_path /nonempty_dir1/nonexist_4/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir
         ((dir_path /nonempty_dir1/nonexist_4/d2/d3) (dir_node 32653)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
      ((DE_dir ((dir_path /) (dir_node 15)))
       ...
       (DE_symlink
        ((link_path /nonempty_dir1/nonexist_4/d2/sl_f3.txt)
         (link_val ../../nonempty_dir1/d2/f3.txt)))
       (DE_dir ((dir_path /nonempty_dir1/nonexist_4/d2/d3) (dir_node 32653))))))))
  (d_lbls ()))
