(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2_____nonexist_2__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1__d2_____nonexist_2__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_RENAME ((CS_Some nonempty_dir1/d2/) (CS_Some nonexist_2/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 25)))
        ...
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 21) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 22) (file_size 167)
        ...
        (DE_dir ((dir_path /nonexist_2) (dir_node 65282)))
        (DE_file
         ((file_path /nonexist_2/f3.txt) (file_node 14) (file_size 83)
          (file_sha 4b535f836f6006423fc132a59e78dfcc4fe6292f)))
        (DE_symlink ((link_path /nonexist_2/sl_dotdot_d2) (link_val ../d2)))
        (DE_symlink
         ((link_path /nonexist_2/sl_dotdot_f1.txt) (link_val ../f1.txt)))
        (DE_symlink
         ((link_path /nonexist_2/sl_dotdot_no_such_target)
          (link_val ../no_such_target)))
        (DE_symlink
         ((link_path /nonexist_2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonexist_2/d3) (dir_node 65283)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
      ((DE_dir ((dir_path /) (dir_node 25)))
       ...
       (DE_symlink
        ((link_path /nonexist_2/sl_dotdot_no_such_target)
         (link_val ../no_such_target)))
       (DE_symlink
        ((link_path /nonexist_2/sl_no_such_target) (link_val no_such_target)))
       (DE_dir ((dir_path /nonexist_2/d3) (dir_node 65283))))))))
  (d_lbls ()))
