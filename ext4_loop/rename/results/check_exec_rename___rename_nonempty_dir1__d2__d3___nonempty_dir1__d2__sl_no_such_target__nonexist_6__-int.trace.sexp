(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__d3___nonempty_dir1__d2__sl_no_such_target__nonexist_6__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__d3___nonempty_dir1__d2__sl_no_such_target__nonexist_6__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32650)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 65289)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 65290)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 65291)))
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 38) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonempty_dir1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 65292)))
        (DE_file
        ...
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 40) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 41) (file_size 167)
