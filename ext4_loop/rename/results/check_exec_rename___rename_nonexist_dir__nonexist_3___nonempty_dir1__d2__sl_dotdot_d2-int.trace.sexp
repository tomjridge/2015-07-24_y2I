(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonexist_dir__nonexist_3___nonempty_dir1__d2__sl_dotdot_d2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonexist_dir__nonexist_3___nonempty_dir1__d2__sl_dotdot_d2")))
  (d_lbls ()))
 ((trace_ctxt ())
