(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2__f2.txt___nonempty_dir1__nonexist_4-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir2__f2.txt___nonempty_dir1__nonexist_4")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_file
         ((file_path /nonempty_dir1/nonexist_4) (file_node 23)
          (file_size 167)
      ...
      ((DE_dir ((dir_path /) (dir_node 32641)))
       ...
       (DE_file
        ((file_path /nonempty_dir1/f1.txt) (file_node 20) (file_size 0)
         (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
       (DE_file
        ((file_path /nonempty_dir1/nonexist_4) (file_node 23) (file_size 167)
         (file_sha d09f4e47c22373e56c2369633ac3dcb71d598601)))
       (DE_symlink ((link_path /nonempty_dir1/sl_f1.txt) (link_val f1.txt)))
       (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 65281)))
       (DE_file
