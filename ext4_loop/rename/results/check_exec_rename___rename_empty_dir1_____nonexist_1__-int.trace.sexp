(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_empty_dir1_____nonexist_1__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_empty_dir1_____nonexist_1__")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 17)))
        ...
        (DE_dir ((dir_path /nonexist_1) (dir_node 20)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
