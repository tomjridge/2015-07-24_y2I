(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2__f3.txt___nonempty_dir1__d2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonempty_dir1__d2__f3.txt___nonempty_dir1__d2")))
  (d_lbls ()))
 ((trace_ctxt ())
