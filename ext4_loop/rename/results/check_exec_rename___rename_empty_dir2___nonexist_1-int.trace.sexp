(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_empty_dir2___nonexist_1-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_empty_dir2___nonexist_1")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 16)))
        ...
        (DE_dir ((dir_path /nonexist_1) (dir_node 13)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
