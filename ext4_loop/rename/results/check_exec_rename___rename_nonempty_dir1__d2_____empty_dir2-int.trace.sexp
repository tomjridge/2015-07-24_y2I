(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2_____empty_dir2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1__d2_____empty_dir2")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_dir ((dir_path /empty_dir2) (dir_node 65281)))
        (DE_file
         ((file_path /empty_dir2/f3.txt) (file_node 13) (file_size 83)
        ...
        (DE_symlink
         ((link_path /empty_dir2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /empty_dir2/d3) (dir_node 65282)))
