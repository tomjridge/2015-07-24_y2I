(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonexist_1___nonempty_dir1__d2__sl_no_such_target-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment
     " Test rename___rename_nonexist_1___nonempty_dir1__d2__sl_no_such_target")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_RENAME
          ((CS_Some nonexist_1) (CS_Some nonempty_dir1/d2/sl_no_such_target))))))))))
  (d_lbls ()))
