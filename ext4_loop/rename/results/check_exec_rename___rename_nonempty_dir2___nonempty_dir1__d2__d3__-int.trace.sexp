(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir2___nonempty_dir1__d2__d3__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test rename___rename_nonempty_dir2___nonempty_dir1__d2__d3__")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_RENAME
           ((CS_Some nonempty_dir2) (CS_Some nonempty_dir1/d2/d3/)))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1)
         (OS_RENAME ((CS_Some nonempty_dir2) (CS_Some nonempty_dir1/d2/d3/))))))))))
  (d_lbls ()))
 ...
 ((trace_ctxt
   (((77)
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 65284)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 65282)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 65283)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 97921)))
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 19) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonempty_dir1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 97922)))
        (DE_file
         ((file_path /nonempty_dir1/d2/f3.txt) (file_node 13) (file_size 83)
        ...
        (DE_symlink
         ((link_path /nonempty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 97924)))
        (DE_file
         ((file_path /nonempty_dir1/d2/d3/f1.txt) (file_node 21)
          (file_size 0) (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir1/d2/d3/f2.txt) (file_node 22)
          (file_size 167)
          (file_sha d09f4e47c22373e56c2369633ac3dcb71d598601)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3/d2) (dir_node 32641)))
        (DE_symlink
         ((link_path /nonempty_dir1/d2/d3/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonempty_dir1/d2/d3/d2/d3) (dir_node 32642)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
      ((DE_dir ((dir_path /) (dir_node 65284)))
       ...
       (DE_dir ((dir_path /nonempty_dir1/d2/d3) (dir_node 97924)))
       (DE_file
        ((file_path /nonempty_dir1/d2/d3/f1.txt) (file_node 21) (file_size 0)
         (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
       (DE_file
        ((file_path /nonempty_dir1/d2/d3/f2.txt) (file_node 22)
