(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1__d2_____nonexist_2-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1__d2_____nonexist_2")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 15)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 16)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 17)))
        (DE_dir ((dir_path /nonempty_dir1) (dir_node 18)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 28)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 31)))
        (DE_symlink
         ((link_path /nonempty_dir2/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 32)))
        (DE_dir ((dir_path /nonexist_2) (dir_node 19)))
        (DE_file
         ((file_path /nonexist_2/f3.txt) (file_node 20) (file_size 83)
        ...
        (DE_symlink
         ((link_path /nonexist_2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonexist_2/d3) (dir_node 21)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
