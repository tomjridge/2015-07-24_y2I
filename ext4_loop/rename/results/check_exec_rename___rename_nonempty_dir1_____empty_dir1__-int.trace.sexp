(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1_____empty_dir1__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1_____empty_dir1__")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((77)
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 65281)))
        (DE_dir ((dir_path /empty_dir1) (dir_node 65284)))
        (DE_file
         ((file_path /empty_dir1/f1.txt) (file_node 26) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /empty_dir1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /empty_dir1/d2) (dir_node 65285)))
        (DE_file
         ((file_path /empty_dir1/d2/f3.txt) (file_node 21) (file_size 83)
        ...
        (DE_symlink
         ((link_path /empty_dir1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /empty_dir1/d2/d3) (dir_node 65286)))
        (DE_dir ((dir_path /empty_dir2) (dir_node 65283)))
        (DE_dir ((dir_path /nonempty_dir2) (dir_node 65287)))
        (DE_file
        ...
        (DE_dir ((dir_path /nonempty_dir2/d2) (dir_node 65288)))
        (DE_symlink
         ((link_path /nonempty_dir2/d2/sl_f3.txt)
          (link_val ../../nonempty_dir1/d2/f3.txt)))
        (DE_dir ((dir_path /nonempty_dir2/d2/d3) (dir_node 65289)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
