(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rename___rename_nonempty_dir1___nonexist_1-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rename___rename_nonempty_dir1___nonexist_1")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_dir ((dir_path /nonexist_1) (dir_node 32644)))
        (DE_file
         ((file_path /nonexist_1/f1.txt) (file_node 19) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_symlink ((link_path /nonexist_1/sl_f1.txt) (link_val f1.txt)))
        (DE_dir ((dir_path /nonexist_1/d2) (dir_node 65281)))
        (DE_file
         ((file_path /nonexist_1/d2/f3.txt) (file_node 13) (file_size 83)
        ...
        (DE_symlink
         ((link_path /nonexist_1/d2/sl_no_such_target)
          (link_val no_such_target)))
        (DE_dir ((dir_path /nonexist_1/d2/d3) (dir_node 65282)))))))))
  (trace_line
   ((77)
    (Dump_result
     (/
