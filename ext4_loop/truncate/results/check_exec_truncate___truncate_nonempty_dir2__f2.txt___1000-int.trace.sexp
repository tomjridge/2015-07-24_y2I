(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir2__f2.txt___1000-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test truncate___truncate_nonempty_dir2__f2.txt___1000")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_TRUNCATE ((CS_Some nonempty_dir2/f2.txt) 1000))))))))))
  (trace_line
   ((73)
    (Label
     (false
       ...
       ((DE_dir ((dir_path /) (dir_node 32642)))
        ...
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 22) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 23) (file_size 1000)
          (file_sha 399f5ffef7a3ffbb2de9b4a80f09cb13f6d2a697)))
