(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir2__d2__sl_f3.txt_____10-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test truncate___truncate_nonempty_dir2__d2__sl_f3.txt_____10")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_TRUNCATE ((CS_Some nonempty_dir2/d2/sl_f3.txt/) 10))))))))))
  (trace_line
   ((73)
    (Label
     (false
