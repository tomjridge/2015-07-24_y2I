(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonexist_1___-100-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " Test truncate___truncate_nonexist_1___-100")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_TRUNCATE ((CS_Some nonexist_1) -100))))))))))
  (trace_line
   ((73)
    (Label
     (false
