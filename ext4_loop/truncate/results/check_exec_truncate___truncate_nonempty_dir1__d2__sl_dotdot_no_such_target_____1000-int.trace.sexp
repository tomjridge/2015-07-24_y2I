(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir1__d2__sl_dotdot_no_such_target_____1000-int.trace' ...")))
  (d_lbls ()))
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_TRUNCATE
           ((CS_Some nonempty_dir1/d2/sl_dotdot_no_such_target/) 1000))))))))))
  (trace_line
   ((73)
    (Label
     (false
