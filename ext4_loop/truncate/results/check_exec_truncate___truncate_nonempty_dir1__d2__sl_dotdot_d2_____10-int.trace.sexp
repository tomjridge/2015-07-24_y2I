(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir1__d2__sl_dotdot_d2_____10-int.trace' ...")))
  (d_lbls ()))
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_TRUNCATE ((CS_Some nonempty_dir1/d2/sl_dotdot_d2/) 10))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1) (OS_TRUNCATE ((CS_Some nonempty_dir1/d2/sl_dotdot_d2/) 10)))))))))
  (d_lbls ()))
