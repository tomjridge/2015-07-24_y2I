(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir1__f1.txt__nonexist_5___0-int.trace' ...")))
  (d_lbls ()))
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_TRUNCATE ((CS_Some nonempty_dir1/f1.txt/nonexist_5) 0))))))))))
  (trace_line
   ((73)
    (Label
     (false
      (OS_simple_label
       (OS_CALL
        ((Pid 1) (OS_TRUNCATE ((CS_Some nonempty_dir1/f1.txt/nonexist_5) 0)))))))))
  (d_lbls ()))
