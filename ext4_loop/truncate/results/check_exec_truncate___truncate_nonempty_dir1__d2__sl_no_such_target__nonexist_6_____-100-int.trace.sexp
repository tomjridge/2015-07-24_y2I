(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir1__d2__sl_no_such_target__nonexist_6_____-100-int.trace' ...")))
  (d_lbls ()))
      ...
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_TRUNCATE
           ((CS_Some nonempty_dir1/d2/sl_no_such_target/nonexist_6/) -100))))))))))
  (trace_line
   ((73)
    (Label
     (false
