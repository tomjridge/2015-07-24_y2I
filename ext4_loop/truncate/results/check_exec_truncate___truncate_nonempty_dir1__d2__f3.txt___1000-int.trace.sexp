(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir1__d2__f3.txt___1000-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test truncate___truncate_nonempty_dir1__d2__f3.txt___1000")))
  (d_lbls ()))
 ((trace_ctxt ())
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_file
         ((file_path /nonempty_dir1/d2/f3.txt) (file_node 16)
          (file_size 1000)
    ...
    (Dump_result
     (/
      ((DE_dir ((dir_path /) (dir_node 32641)))
       ...
       (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 32647)))
       (DE_file
        ((file_path /nonempty_dir1/d2/f3.txt) (file_node 16) (file_size 1000)
         (file_sha f7421938baaac6a3fd7e5e340397873bba5c4382)))
       (DE_symlink
        ((link_path /nonempty_dir1/d2/sl_dotdot_d2) (link_val ../d2)))
       (DE_symlink
