(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir2__d2__sl_f3.txt___1000-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4)
    (Comment " Test truncate___truncate_nonempty_dir2__d2__sl_f3.txt___1000")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_TRUNCATE ((CS_Some nonempty_dir2/d2/sl_f3.txt) 1000))))))))))
  (trace_line
   ((73)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 18)))
        ...
        (DE_file
         ((file_path /nonempty_dir1/d2/f3.txt) (file_node 31)
          (file_size 1000)
          (file_sha f7421938baaac6a3fd7e5e340397873bba5c4382)))
        (DE_symlink
        ...
        (DE_file
         ((file_path /nonempty_dir2/f1.txt) (file_node 38) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /nonempty_dir2/f2.txt) (file_node 39) (file_size 167)
    ...
    (Dump_result
     (/
      ((DE_dir ((dir_path /) (dir_node 18)))
       ...
       (DE_dir ((dir_path /nonempty_dir1/d2) (dir_node 32648)))
       (DE_file
        ((file_path /nonempty_dir1/d2/f3.txt) (file_node 31) (file_size 1000)
         (file_sha f7421938baaac6a3fd7e5e340397873bba5c4382)))
       (DE_symlink
        ((link_path /nonempty_dir1/d2/sl_dotdot_d2) (link_val ../d2)))
       (DE_symlink
