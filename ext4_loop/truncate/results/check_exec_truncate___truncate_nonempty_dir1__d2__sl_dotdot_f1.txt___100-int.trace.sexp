(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'truncate___truncate_nonempty_dir1__d2__sl_dotdot_f1.txt___100-int.trace' ...")))
  (d_lbls ()))
     ...
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1)
          (OS_TRUNCATE ((CS_Some nonempty_dir1/d2/sl_dotdot_f1.txt) 100))))))))))
  (trace_line
   ((73)
    (Label
     (false
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        ...
        (DE_file
         ((file_path /nonempty_dir1/f1.txt) (file_node 17) (file_size 100)
