(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment " processing file 'adhoc_lseek_test_SEEK_DATA-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " for coverage purposes test lseek SEEK_DATA")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((13)
     (Label
      (false (OS_simple_label (OS_CALL ((Pid 1) (OS_LSEEK ((FD 3) 0 3))))))))))
  (trace_line
   ((13)
    (Label
     (false (OS_simple_label (OS_CALL ((Pid 1) (OS_LSEEK ((FD 3) 0 3)))))))))
