(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_group_create_230-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_group_create_230")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((52)
     (Label
      (true
       (OS_simple_label
        (OS_CALL ((Pid 2) (OS_CHMOD ((CS_Some /d) (File_perm 152)))))))))))
  (trace_line
   ((52)
    (Label
     (true
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32641)))
        (DE_dir ((dir_path /d) (dir_node 32642)))
        (DE_file
         ((file_path /d/f1) (file_node 17) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /d/f2) (file_node 12) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /d/f3) (file_node 18) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /d/f4) (file_node 16) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_dir ((dir_path /d/d1) (dir_node 32650)))
        (DE_dir ((dir_path /d/d2) (dir_node 32645)))
        (DE_dir ((dir_path /d/d3) (dir_node 32651)))
        (DE_dir ((dir_path /d/d4) (dir_node 32649)))))))))
  (trace_line
   ((86)
    (Dump_result
     (/
