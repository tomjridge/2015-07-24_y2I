(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_group_create_050-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_group_create_050")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((52)
     (Label
      (true
       (OS_simple_label
        (OS_CALL ((Pid 2) (OS_CHMOD ((CS_Some /d) (File_perm 40)))))))))))
  (trace_line
   ((52)
    (Label
     (true
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32642)))
        (DE_dir ((dir_path /d) (dir_node 32644)))
        (DE_file
