(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_umask_022-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_umask_022")))
  (d_lbls ()))
 ((trace_ctxt ())
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 18)) (st_kind S_IFREG)
             (st_perm (File_perm 192)) (st_nlink 1) (st_uid (User_id 0))
             (st_gid (Group_id 0)) (st_rdev 0) (st_size 0)
             (st_atime (Float 0)) (st_mtime (Float 0)) (st_ctime (Float 0)))))))))))))
  (trace_line
   ((58)
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 32649)) (st_kind S_IFDIR)
             (st_perm (File_perm 192)) (st_nlink 2) (st_uid (User_id 0))
             (st_gid (Group_id 0)) (st_rdev 0) (st_size 4096)
             (st_atime (Float 0)) (st_mtime (Float 0)) (st_ctime (Float 0)))))))))))))
  (trace_line
   ((65)
