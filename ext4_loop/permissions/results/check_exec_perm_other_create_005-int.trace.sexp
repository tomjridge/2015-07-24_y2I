(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_other_create_005-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_other_create_005")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((49)
     (Label
      (true
       (OS_simple_label
        (OS_CALL ((Pid 2) (OS_CHMOD ((CS_Some /d) (File_perm 5)))))))))))
  (trace_line
   ((49)
    (Label
     (true
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32644)))
        (DE_dir ((dir_path /d) (dir_node 32646)))
        (DE_file
         ((file_path /d/f2) (file_node 13) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_file
         ((file_path /d/f4) (file_node 14) (file_size 0)
          (file_sha da39a3ee5e6b4b0d3255bfef95601890afd80709)))
        (DE_dir ((dir_path /d/d2) (dir_node 32647)))
        (DE_dir ((dir_path /d/d4) (dir_node 32648)))))))))
  (trace_line
   ((83)
    (Dump_result
     (/
