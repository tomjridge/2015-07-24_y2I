(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_umask_011-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_umask_011")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((9)
     (Label
      (false (OS_simple_label (OS_CALL ((Pid 1) (OS_UMASK (File_perm 9))))))))))
  (trace_line
   ((9)
    (Label
     (false (OS_simple_label (OS_CALL ((Pid 1) (OS_UMASK (File_perm 9)))))))))
 ...
 ((trace_ctxt
   (((14)
     (Label
      (false
       (OS_simple_label
        (OS_RETURN ((Pid 1) (Value (RV_file_perm (File_perm 9)))))))))))
  (trace_line
   ((14)
    (Label
     (false
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 18)) (st_kind S_IFREG)
             (st_perm (File_perm 502)) (st_nlink 1) (st_uid (User_id 0))
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 32644)) (st_kind S_IFDIR)
             (st_perm (File_perm 502)) (st_nlink 2) (st_uid (User_id 0))
