(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_umask_770-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_umask_770")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((9)
     (Label
      (false
       (OS_simple_label (OS_CALL ((Pid 1) (OS_UMASK (File_perm 504))))))))))
  (trace_line
   ((9)
    (Label
     (false (OS_simple_label (OS_CALL ((Pid 1) (OS_UMASK (File_perm 504)))))))))
  (d_lbls ()))
 ...
 ((trace_ctxt
   (((14)
     (Label
      (false
       (OS_simple_label
        (OS_RETURN ((Pid 1) (Value (RV_file_perm (File_perm 504)))))))))))
  (trace_line
   ((14)
    (Label
     (false
       ...
       (OS_simple_label
        (OS_RETURN
         ((Pid 1)
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 15)) (st_kind S_IFLNK)
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 18)) (st_kind S_IFREG)
             (st_perm (File_perm 7)) (st_nlink 1) (st_uid (User_id 0))
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 32648)) (st_kind S_IFDIR)
             (st_perm (File_perm 7)) (st_nlink 2) (st_uid (User_id 0))
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 19)) (st_kind S_IFREG)
             (st_perm (File_perm 4)) (st_nlink 1) (st_uid (User_id 0))
             (st_gid (Group_id 0)) (st_rdev 0) (st_size 0)
             (st_atime (Float 0)) (st_mtime (Float 0)) (st_ctime (Float 0)))))))))))))
  (trace_line
   ((44)
       ...
       (OS_simple_label
        (OS_RETURN
         ((Pid 1)
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 32649)) (st_kind S_IFDIR)
             (st_perm (File_perm 4)) (st_nlink 2) (st_uid (User_id 0))
             (st_gid (Group_id 0)) (st_rdev 0) (st_size 4096)
             (st_atime (Float 0)) (st_mtime (Float 0)) (st_ctime (Float 0)))))))))))))
  (trace_line
   ((51)
       ...
       (OS_simple_label
        (OS_RETURN
         ((Pid 1)
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 20)) (st_kind S_IFREG)
             (st_perm (File_perm 2)) (st_nlink 1) (st_uid (User_id 0))
             (st_gid (Group_id 0)) (st_rdev 0) (st_size 0)
             (st_atime (Float 0)) (st_mtime (Float 0)) (st_ctime (Float 0)))))))))))))
  (trace_line
   ((58)
          ...
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 65281)) (st_kind S_IFDIR)
             (st_perm (File_perm 2)) (st_nlink 2) (st_uid (User_id 0))
             (st_gid (Group_id 0)) (st_rdev 0) (st_size 4096)
             (st_atime (Float 0)) (st_mtime (Float 0)) (st_ctime (Float 0)))))))))))))
  (trace_line
   ((65)
       ...
       (OS_simple_label
        (OS_RETURN
         ((Pid 1)
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 21)) (st_kind S_IFREG)
