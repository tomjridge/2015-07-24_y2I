(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_group_open_550-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_group_open_550")))
  (d_lbls ()))
 ((trace_ctxt ())
      ...
      (true
       (OS_simple_label
        (OS_CALL
         ((Pid 2)
          (OS_EXTENDED_CMD
           (OS_OPEN_CLOSE ((CS_Some /d/f) 66 ((File_perm 360)))))))))))))
  (trace_line
   ((29)
    (Label
     (true
