(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_group_create_500-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_group_create_500")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((52)
     (Label
      (true
       (OS_simple_label
        (OS_CALL ((Pid 2) (OS_CHMOD ((CS_Some /d) (File_perm 320)))))))))))
  (trace_line
   ((52)
    (Label
     (true
     ...
     (Dump_result
      (/
       ((DE_dir ((dir_path /) (dir_node 32643)))
        ...
        (DE_file
         ((file_path /d/f2) (file_node 15) (file_size 0)
        ...
        (DE_dir ((dir_path /d/d4) (dir_node 97923)))))))))
  (trace_line
   ((86)
    (Dump_result
     (/
