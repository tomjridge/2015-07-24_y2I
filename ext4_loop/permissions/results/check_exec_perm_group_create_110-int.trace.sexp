(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_group_create_110-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_group_create_110")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((52)
     (Label
      (true
       (OS_simple_label
        (OS_CALL ((Pid 2) (OS_CHMOD ((CS_Some /d) (File_perm 72)))))))))))
  (trace_line
   ((52)
    (Label
     (true
