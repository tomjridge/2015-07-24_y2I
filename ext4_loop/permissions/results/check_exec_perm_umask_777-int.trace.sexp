(((trace_ctxt ())
  (trace_line
   ((1) (Comment " processing file 'perm_umask_777-int.trace' ...")))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((2) (Comment "@type trace"))) (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((3) (Comment ####################################)))
  (d_lbls ()))
 ((trace_ctxt ()) (trace_line ((4) (Comment " Test perm_umask_777")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((9)
     (Label
      (false
       (OS_simple_label (OS_CALL ((Pid 1) (OS_UMASK (File_perm 511))))))))))
  (trace_line
   ((9)
    (Label
     (false (OS_simple_label (OS_CALL ((Pid 1) (OS_UMASK (File_perm 511)))))))))
  (d_lbls ()))
 ...
 ((trace_ctxt
   (((14)
     (Label
      (false
       (OS_simple_label
        (OS_RETURN ((Pid 1) (Value (RV_file_perm (File_perm 511)))))))))))
  (trace_line
   ((14)
    (Label
     (false
