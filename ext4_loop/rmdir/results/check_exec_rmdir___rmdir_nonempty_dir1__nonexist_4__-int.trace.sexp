(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'rmdir___rmdir_nonempty_dir1__nonexist_4__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test rmdir___rmdir_nonempty_dir1__nonexist_4__")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_RMDIR (CS_Some nonempty_dir1/nonexist_4/))))))))))
  (trace_line
   ((73)
    (Label
     (false
