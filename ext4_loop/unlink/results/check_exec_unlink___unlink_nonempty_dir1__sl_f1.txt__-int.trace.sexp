(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'unlink___unlink_nonempty_dir1__sl_f1.txt__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test unlink___unlink_nonempty_dir1__sl_f1.txt__")))
  (d_lbls ()))
 ((trace_ctxt ())
 ...
 ((trace_ctxt
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL ((Pid 1) (OS_UNLINK (CS_Some nonempty_dir1/sl_f1.txt/))))))))))
  (trace_line
   ((73)
    (Label
     (false
