(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'adhoc_unlink_restricted_delete_write_dir-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt
   (((19)
     (Label
      (true
       (OS_simple_label
        (OS_CALL ((Pid 2) (OS_MKDIR ((CS_Some /dir) (File_perm 1023)))))))))))
  (trace_line
   ((19)
    (Label
     (true
   ...
   (((23)
     (Label
      (true
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_CHOWN ((CS_Some /dir) (User_id 2) (Group_id 0)))))))))))
  (trace_line
   ((23)
    (Label
     (true
 ...
 ((trace_ctxt
   (((27)
     (Label
      (true (OS_simple_label (OS_CALL ((Pid 2) (OS_UNLINK (CS_Some /dir))))))))))
  (trace_line
   ((27)
    (Label
     (true (OS_simple_label (OS_CALL ((Pid 2) (OS_UNLINK (CS_Some /dir)))))))))
