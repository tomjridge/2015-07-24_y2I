(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'stat___stat_nonempty_dir1__d2__sl_no_such_target__-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  (trace_line
   ((4) (Comment " Test stat___stat_nonempty_dir1__d2__sl_no_such_target__")))
  (d_lbls ()))
 ((trace_ctxt ())
   ...
   (((73)
     (Label
      (false
       (OS_simple_label
        (OS_CALL
         ((Pid 1) (OS_STAT (CS_Some nonempty_dir1/d2/sl_no_such_target/))))))))))
  (trace_line
   ((73)
    (Label
     (false
