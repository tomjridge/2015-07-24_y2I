(((trace_ctxt ())
  (trace_line
   ((1)
    (Comment
     " processing file 'stat___stat_nonempty_dir1__d2__d3-int.trace' ...")))
  (d_lbls ()))
 ...
 ((trace_ctxt ())
  ...
  (d_lbls ()))
 ((trace_ctxt ())
  (trace_line ((4) (Comment " Test stat___stat_nonempty_dir1__d2__d3")))
  (d_lbls ()))
 ((trace_ctxt ())
       ...
       (OS_simple_label
        (OS_RETURN
         ((Pid 1)
          (Value
           (RV_stats
            ((st_dev 1792) (st_ino (Inode 97926)) (st_kind S_IFDIR)
